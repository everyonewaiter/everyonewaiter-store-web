      ...
      >
        ...
        <FormField
          ...
          inputProps={{
            ...
            suffix: <span className="font-regular text-s text-gray-200 lg:text-[15px]">01:00</span>,
          }}
          postfix={
            <Button
              color="black"
        ...
        <div className="mt-1 flex flex-col gap-2 md:mt-0">
          <div className="flex flex-col gap-5 rounded-[10px] border border-gray-600 p-4 lg:gap-6">
            <span className="text-s leading-[150%] font-normal text-[#767676]">
              ...
              민원처리, 고지사항 전달 등)의 목적으로 수집되어 이용됩니다. 또한, 이용자의 개인정보는
              제3자에게 제공되지 않으며, 수집 및 이용목적이 달성된 후에는 지체 없이 파기됩니다.
            </span>
