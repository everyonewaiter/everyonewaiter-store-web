...
function SettingsSwitchItem({ label, propName }: Readonly<SettingsSwitchItemProps>) {
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <Switch checked={checked} onCheckedChange={(checked) => form.setValue(propName, checked)} />
    </div>
  );
}
